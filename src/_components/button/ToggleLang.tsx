		...
		<button
			...
			<div className="relative h-8 w-full">
				...
				<Image
					...
					width={32}
					height={32}
					className={`absolute h-8 w-8 transition-all border-2 rounded-full duration-300 ease-in-out border-black dark:border-white 
						${language === "en" ? "top-0 z-20 translate-x-0" : "top-0 z-0 translate-x-3"}
					`}
				/>

				<div
					className={`absolute h-8 w-8 transition-all border-2 rounded-full duration-300 ease-in-out bg-black/50 
				...
				<Image
					...
					height={32}
					className={`
						absolute h-8 w-8 transition-all border-2 rounded-full duration-300 ease-in-out border-black dark:border-white 
